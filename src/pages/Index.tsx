    ...
    <main className="min-h-screen">
      ...
      <footer className="bg-foreground text-background py-8">
        <div className="container mx-auto px-6 text-center">
          <h3 className="text-2xl font-bold mb-4">Piceria Arti</h3>
          <p className="text-background/80 mb-4">Këtu në fshatit Çekez</p>
          ...
          <div className="mt-6 pt-6 border-t border-background/20 text-background/60 text-sm">
            <p>&copy; 2025 Piceria Arti. Të gjitha të drejtat e rezervuara.</p>
          </div>
        </div>
      </footer>
    </main>
