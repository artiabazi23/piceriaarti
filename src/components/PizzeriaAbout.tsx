  ...
  return <section className="py-20 bg-muted/20">
      <div className="container mx-auto px-6">
        <div className="text-center \n">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed py-0 px-0 font-semibold text-center mx-[275px] my-[15px]">Na pëlqen të bëjmë pica të shijshme me kackavall të freskët dhe përbërës të mirë. Në Piceria Arti</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          return <Card key={index} className="text-center group hover:shadow-warm transition-all duration-300 hover:-translate-y-1 border-2 hover:border-primary/20">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed font-normal text-center ">{feature.description}</p>
                </CardContent>
              </Card>;
        })}
        </div>
